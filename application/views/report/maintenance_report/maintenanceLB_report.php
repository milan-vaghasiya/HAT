                            ...
                            <table id='reportTable' class="table table-bordered">
								<thead class="thead-info" id="theadData">
                                    <tr class="text-center">
                                        <th colspan="9">MACHINE BREAKDOWN MAINTENANCE HISTORY CARD</th>
                                        <th colspan="2">F/MNT/01 (00/01.01.16)</th>
                                    </tr>
									<tr class="text-center">
                                        <th rowspan="2">#</th>
                                            <th rowspan="2">Date</th>
                                            <th rowspan="2">Time</th>
                                            <th rowspan="2">Details of Breakdown</th>
                                            <th rowspan="2">Details of Work Done</th>
                                            <th colspan="2">Maintenance Done</th>
                                            <th rowspan="2">Sign.</th>
                                            <th rowspan="2">Verification Status</th>
                                            <th rowspan="2">Total Breakdown Hours</th>	
                                            <th rowspan="2">Sign.</th>	
                                        </tr>
                                        <tr class="text-center">
                                            <th>By</th>
