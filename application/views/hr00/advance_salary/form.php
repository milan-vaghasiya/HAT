    ...
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="col-md-4 form-group">
                ...
                <input type="number" name="amount" class="form-control numericOnly req" value="<?=(!empty($dataRow->amount))?$dataRow->amount:""?>" />
            </div>

            <div class="col-md-4">
                <label for="date"> Date</label>
                <input type="date" name="date" id="date" class="form-control" value="<?=(!empty($dataRow->date))?$dataRow->date:date("Y-m-d")?>" max="<?=(!empty($dataRow->date))?$dataRow->date:date("Y-m-d")?>" />
            </div>
