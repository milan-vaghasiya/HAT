                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id='holdAreaTable' class="table table-bordered ssTable" data-url='/getMovementDTRows'></table>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function outward(data) {
        ...
        $.ajax({
            type: "POST",
            url: base_url + 'production_v2/processApproval/productionTransaction',
            data: {
                id: data.id,
