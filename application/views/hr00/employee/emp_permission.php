                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="btn-group">
                                        <a href="<?= base_url($headData->controller . "/empPermission/") ?>" class="btn btn-sm btn-outline-primary permission-write active"> General Permission</a>
                                        <a href="<?= base_url($headData->controller . "/empPermissionReport/") ?>" class="btn btn-sm btn-outline-primary permission-write"> Report Permission</a>
                                        <button type="button" class="btn btn-sm btn-outline-success copyPermission permission-write" data-button="save" data-modal_id="modal-md" data-function="copyPermission" data-form_title="Copy Permission">Copy Permission</button>
                                    </div>
                                </div>
