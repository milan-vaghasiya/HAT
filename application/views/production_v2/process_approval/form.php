...
<form style="padding-top:35px;">
    <div class="col-md-12">
        <div class="row">
            ...
            <?php
			$remarkWidth = 'col-md-8';
            if (!empty($dataRow->vp_trans_id) || !empty($trans_ref_id)) {$remarkWidth = 'col-md-6';
            ?>
                <div class="col-md-2 form-group">
            ...
            ?>
            <input type="hidden" name="in_qty_kg">
            <input type="hidden" name="vendor_id" value="0">
            <input type="hidden" name="job_order_id">
            <input type="hidden" name="job_process_ids">
            <input type="hidden" name="in_challan_no">
            <input type="hidden" name="charge_no">
            <input type="hidden" name="remark">
            <input type="hidden" name="entry_type" value="<?=($from_entry_type==2)?4:1?>">
            ...
            <?php } if(!empty($returnVendorMaterial) && !empty($packingData)){ ?>
                <div class="table-responsive">
                    <table id='packingData' class="table table-bordered">
                        <thead class="thead-info">
                            <tr>
                                <th style="width:5%;">#</th>
                                <th>Material</th>
                        ...
                        <?php
                            ...
                            if (!empty($packingData)) :
                                foreach ($packingData as $row) :
                                    ...
                                    <td>
                                        '.$item_name.'
                                        <input type="hidden" name="return_challan_id" value="'.$returnVendorMaterial->id.'">  
                                        <input type="hidden" name="return_item_id[]" value="'.$row->item_id.'">  
                                    </td>
                                    <td>
                                        '.$row->out_qty.'
                                        <input type="hidden" name="return_out_qty[]" value="'.$row->out_qty.'">
                                        <input type="hidden" name="returnQty[]" value="'.$row->in_qty.'">
                                    </td>
                                    <td>
                                        <input type="text" class="form-control floatOnly" name="return_in_qty[]" value="'.$row->in_qty.'">                                
                                    </td>
                                    <td>
                                        '.$pendingQty.'                                
                                    </td>
