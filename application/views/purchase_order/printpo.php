	...
	<div class="col-12">
		...
		<table class="table item-list-bb" style="margin-top:10px;">
			...
			<?php
    			...
    			<tr>
    			    <td colspan="4" rowspan="<?=$rspan?>" style="vertical-align:top;"><b>Notes :</b><br><?=str_replace("\n", '<br />',  $poData->remark)?></td>
			...
			<?php if($poData->gst_type == 2){ ?>
    			<tr>
    				<th colspan="3" class="text-right">IGST</th>
			...
			<tr>
				<td colspan="4" rowspan="2" style="vertical-align:top;"><b>Amount In Words: </b> <?=numToWordEnglish($poData->net_amount)?></td>
