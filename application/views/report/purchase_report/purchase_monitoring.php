                            ...
                            <table id='reportTable' class="table table-bordered">
								<thead class="thead-info" id="theadData">
                                    <tr class="text-center">
                                        <th colspan="9">PURCHASE ORDER MONITORING REGISTER</th>
                                        <th colspan="4">F/PUR/02 (00/01.01.16)</th>
                                    </tr>
									<tr class="text-center">
										<th rowspan="2">#</th>
										...
										<th rowspan="2" style="min-width:80px;">Wo. No.</th>
...
$(document).ready(function(){
    ...
    $(document).on('click','.loaddata',function(e){
		...
		var sendData = {item_type:item_type,from_date:from_date, to_date:to_date,type:type};
		...
		{
			if(type == 1){
				var url =  base_url + '/reports/purchaseReport/getPurchaseMonitoring/' + encodeURIComponent(window.btoa(JSON.stringify(sendData)));
				window.open(url);
