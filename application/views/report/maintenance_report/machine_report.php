                            ...
                            <table id='reportTable' class="table table-bordered">
								<thead class="thead-info" id="theadData">
                                    <tr class="text-center">
                                        <th colspan="5">LIST OF PLANT MACHINES</th>
                                        <th colspan="3">D/MNT/01 (00/01.01.16)</th>
                                    </tr>
									<tr>
										<th>#</th>
										...
										<th>Make/Model</th>
										<th>Capacity/Size</th>
										<th>Maintenance req.<br /><small>(Yes/No)</small></th>
								...
								<tbody>
									...
									foreach($machineData as $row):
										echo '<tr>
											...
											<td>'.formatDate($row->installation_date).'</td>
