            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-7">
                                <h4 class="card-title pageHeader">CUSTOMER COMPLAINT REGISTER</h4>
                            </div>
                            <div class="col-md-2">   
                        ...
                        <div class="table-responsive">
                            <table id='reportTable' class="table table-bordered">
                                ...
                                <tr class="text-center">
                                        <th colspan="8">CUSTOMER COMPLAINT REGISTER</th>
                                        <th colspan="2">F/MKT/06 (00/01.01.16)</th>
                                </tr>
									<tr>
										<th>Sr. No.</th>
										<th>Receipt Date</th>
										...
										<th>Product Returned (Yes/ No)</th>
                                        <th>Details of Action Taken / CA Report No.</th>
                                        <th>Reference of feed back to Customer</th>
                                        <th>Remarks</th>
									</tr>
								</thead>
								<tbody id="tbodyData">						
...
//         var sendData = {from_date:from_date, to_date:to_date,type:type};
	
// 		if(valid){
//             if(type == 1){
// 				var url =  base_url + '/reports/salesReport/salesCustomerComplaints/' + encodeURIComponent(window.btoa(JSON.stringify(sendData)));
// 				window.open(url);
				
// 			}else{
//                 $.ajax({
//                     url: base_url + controller + '/salesCustomerComplaints',
//                     data: sendData,
//                     type: "POST",
//                     dataType:'json',
