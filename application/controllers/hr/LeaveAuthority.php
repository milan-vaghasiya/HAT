...
class LeaveAuthority extends MY_Controller
{
	...
	public function getEmpLeaveAuthDetail(){
        ...
        $empData = $this->employee->getEmpList(['emp_grade'=>"'A'"]);
    ...
    public function saveAuthority(){
		...
		if(!empty($errorMessage)):
        	...
        	//print_r($data);exit;
        	$result = $this->leaveAuthorityModel->saveAuthority($data);
