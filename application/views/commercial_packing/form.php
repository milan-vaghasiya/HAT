                    ...
                    <div class="card-body">
                        <form autocomplete="off" id="saveCommercialPacking" enctype="multipart/form-data">
                        	<div class="col-md-12">
                                ...
                                <input type="hidden" name="extra_fields[packing_master_id]" id="packing_master_id" value="">
                                <input type="hidden" name="extra_fields[no_of_wooden_box]" id="no_of_wooden_box" value="">
