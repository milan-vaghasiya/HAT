                        ...
                        <form id="addMasterOptions">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <!--<div class="col-md-12 form-group">
                                        <label for="ins_param">Inspection Parameter</label>
                                        <input type="text" name="ins_param" id="ins_param" class="form-control req" value="<?= (!empty($dataRow->ins_param)) ? $dataRow->ins_param : "" ?>" data-role="tagsinput">
                                    </div>
                                    <div class="col-md-12 form-group">
