                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="btn-group">
                                        <a href="<?= base_url($headData->controller . "/empPermission/") ?>" class="btn btn-sm btn-outline-primary permission-write"> General Permission</a>
                                        <a href="<?= base_url($headData->controller . "/empPermissionReport/") ?>" class="btn btn-sm btn-outline-primary permission-write active"> Report Permission</a>
